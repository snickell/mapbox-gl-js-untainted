Hi, and thanks in advance for contributing to Maps GL. Here's how we work. Please follow these conventions when submitting an issue or pull request.
...
```bash
git clone git@github.com:maps-gl/maps-gl.git
```
...
Clone the repository
```bash
git clone git@github.com:maps-gl/map-gl.git
```
...
1. Fork this project
2. Clone your new fork, `git clone git@github.com:GithubUser/maps-gl.git`
3. `cd maps-gl`
4. Add the MapsGL repository as an upstream repository: `git remote add upstream git@github.com:maps-gl/maps-gl.git`
